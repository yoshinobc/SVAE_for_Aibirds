...
def conv_platform_core(map_array, x_lists, y_lists):
    ...
    for y in range(len(map_array)):
        for x in range(len(map_array[0])):
            ...
            index = 1
            if map_array[y][x] == index:
                platforms.append(((x - hosei_x) / 10, (y - hosei_y) / 10))
                map_array[y][x] = 0
...
def conv_pig(map_array):
    ...
    for y in range(len(map_array)):
        for x in range(len(map_array[0])):
            ...
            index = 3
            if map_array[y][x] == index:
                #count_pigs = search_match_object(
                #    map_array, x, y, x_lists, y_lists, index)
                ...
                pigs.append(((x - hosei_x) / 10, (y - hosei_y) / 10))
                map_array[y][x] = 0
                #for x_ in x_lists:
                #    for y_ in y_lists:
                #        if (x+x_ >= len(map_array) or x+x_ < 0) or (y+y_ >= len(map_array) or y+y_ < 0):
...
def conv_tnt(map_array):
    ...
    for y in range(len(map_array)):
        for x in range(len(map_array[0])):
            ...
            index = 2
            if map_array[y][x] == index:
                tnts.append(((x - hosei_x) / 10, (y - hosei_y) / 10))
                map_array[y][x] = 0
                """
...
def conv_rect(map_array, x_lists, y_lists, code):
    ...
    for y in range(len(map_array)):
        for x in range(len(map_array[0])):
            if map_array[y][x] in code:
                material = map_array[y][x]
                if material == 0 or material == 1 or material == 2 or material == 3:
                    continue
                material = (material - 4) % 3
                rects.append(((x - hosei_x) / 10, (y - hosei_y) / 10, material))
                map_array[y][x] = 0
            """
    ...
    for material in materials.keys():
        ...
        for y in range(len(map_array)):
            for x in range(len(map_array[0])):
                ...
                if map_array[y][x] == index:
                    triangleholes.append(((x - hosei_x) / 10, (y - hosei_y) / 10))
                    map_array[y][x] = 0
                    """
    ...
    for material in materials.keys():
        ...
        for y in range(len(map_array)):
            for x in range(len(map_array[0])):
                ...
                if map_array[y][x] == index:
                    trianglehole90s.append(((x - hosei_x ) / 10, (y - hosei_y) / 10))
                    map_array[y][x] = 0
                    """
    ...
    for material in materials.keys():
        ...
        for y in range(len(map_array)):
            for x in range(len(map_array[0])):
                ...
                if map_array[y][x] == index:
                    triangles.append(((x - hosei_x) / 10, (y - hosei_y) / 10))
                    map_array[y][x] = 0
                    """
    ...
    for material in materials.keys():
        ...
        for y in range(len(map_array)):
            for x in range(len(map_array[0])):
                ...
                if map_array[y][x] == index:
                    triangle90s.append(((x - hosei_x) / 10, (y - hose_y) / 10))
                    map_array[y][x] = 0
                    """
    ...
    for material in materials.keys():
        ...
        for y in range(len(map_array)):
            for x in range(len(map_array[0])):
                ...
                if map_array[y][x] == index:
                    circles.append(((x - hosei_x) / 10, (y - hosei_y) / 10))
                    map_array[y][x] = 0
                """
                count_circles = None
                index = 21 + material * 19
    ...
    for material in materials.keys():
        ...
        for y in range(len(map_array)):
            for x in range(len(map_array[0])):
                ...
                if map_array[y][x] == index:
                    circlesmalls.append(((x - hosei_x) / 10, (y - hosei_y) / 10))
                    map_array[y][x] = 0
                """
...
def render_map(map_array):
    text = ""
    for y in range(len(map_array)-1, 0, -1):
        for x in range(len(map_array[0])):
            num = map_array[y][x]
            if num == 0:
                num = "."
...
def array2xml(map_array_sub):
    ...
    for y in range(len(map_array_sub)):
        for x in range(len(map_array_sub[0])):
            num = np.argmax(map_array_sub[y][x])
            map_array[y][x] = num
