...
class VAE(VAECommon):
    ...
    def getBatchGen(self, args, is_shuffle=True, batch_size=None):
        if batch_size == None:
        ...
        tt_gen = gens.batch(tt_now, batch_size)
        for tt in tt_gen:
            yield tt

    def getBatchGen_test(self, args, is_shuffle=True, batch_size=None):
        if batch_size == None:
